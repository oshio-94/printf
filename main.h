...
/**
 * struct print - struct for printing various 
 * @type_arg: identifiers / which type to print
 * @f: function to print
 *
 * Description: struct that stores pointers
 */
...
int (*print_opfunc(const char *s, int index))(va_list, char *, unsigned int);
int print_func_id(const char *s, int index);
